...
check_files() {
   ...
   files=( ${DATPATH}/${RUNID}/ACC*_${YEARB}*.nc )
   files1=( ${DATPATH}/${RUNID}/AMU*_${YEARB}*.nc )
   files2=( ${DATPATH}/${RUNID}/WROSS*_${YEARB}*.nc )
   files3=( ${DATPATH}/${RUNID}/EROSS*_${YEARB}*.nc )
   files4=( ${DATPATH}/${RUNID}/WED*_${YEARB}*.nc )
   files5=( ${DATPATH}/${RUNID}/WG*_${YEARB}*.nc )
   files6=( ${DATPATH}/${RUNID}/RG*_${YEARB}*.nc )
   files7=( ${DATPATH}/${RUNID}/WMXL*_${YEARB}*.nc )
   ...
   nf6=${#files6[@]}
   nf7=${#files7[@]}
   #echo "nfiles $nf $nf1 $nf2 $nf3 $nf4 $nf5 $nf6 $nf7"
...
for RUNID in `echo $RUNIDS`; do
   ...
   YEAR=$start
      ...
      for MONTH in `printf "%02d " $LSTM`; do
         ...
         echo "month ACC $MONTH $TAG $runACC $runTRP"
