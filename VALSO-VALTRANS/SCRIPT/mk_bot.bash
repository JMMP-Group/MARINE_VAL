...
$CDFPATH/cdfmean -f $FILEOUT -v '|thetao|thetao_con|votemper|' -p T -var -w ${ijbox} 0 0 -minmax -o AMU_thetao_$FILEOUT 
...
$CDFPATH/cdfmean -f $FILEOUT -v '|so|so_abs|vosaline|'     -p T -var -w ${ijbox} 0 0 -minmax -o WROSS_so_$FILEOUT 
...
$CDFPATH/cdfmean -f $FILEOUT -v '|thetao|thetao_con|votemper|' -p T -var -w ${ijbox} 0 0 -minmax -o EROSS_thetao_$FILEOUT 
...
$CDFPATH/cdfmean -f $FILEOUT -v '|so|so_abs|vosaline|'     -p T -var -w ${ijbox} 0 0 -minmax -o WED_so_$FILEOUT 
