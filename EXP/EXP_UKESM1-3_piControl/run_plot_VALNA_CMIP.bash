...
ln -s ${KEY}_amoc_z.png tmp15.png
ln -s ${KEY}_amoc_rho.png tmp16.png
...
# compose surface dynamics and T/S plot
convert \( tmp01.png tmp02.png tmp03.png +append \) \
        \( tmp04.png tmp00.png tmp05.png +append \) \
        \( tmp06.png tmp07.png tmp08.png +append \) \
           tmp-2.png tmp-1.png -append -trim -bordercolor White -border 50 ${KEY}-1.png

# compose surface dynamics and T/S plot
convert \( tmp09.png tmp10.png tmp11.png +append \) \
        \( tmp12.png tmp13.png tmp14.png +append \) \
        \( tmp15.png tmp16.png tmp00.png +append \) \
