...
export NMLPATH=/data/users/andrea.rochner/TOOLBOXES/MARINE_VAL/nam_cdf_names_UKCM2
...
export DATPATH=${SCRATCH}/MARINE_VAL/EXP_TESTING/
...
runACC=1            # Drake Passage net eastward transport
...
runMHT=0            # 0 NB: MHT metric only works if relevant diagnostic 
...
runOSNAP=0          # 0 Overturning streamfunction profile in density space accros OSNAP 
